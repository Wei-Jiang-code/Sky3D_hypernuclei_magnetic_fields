...
# ----- targets--------------------------------------------------------------
#
.PHONY : seq mpi omp debug seq_debug omp_debug mpi_debug mpi-omp ifort ifort_seq ifort_omp makeit clean clean-exec
#
...
# ----- define libraries-----------------------------------------------------
#
seq omp debug seq_debug omp_debug ifort ifort_seq ifort_omp : export LIBS_SKY = -lfftw3 -llapack -lblas
mpi mpi_debug mpi-omp                                       : export LIBS_SKY = -lfftw3 -lscalapack -llapack -lblas
#
...
seq_debug mpi_debug debug : export COMPILERFLAGS_SKY = -O0 -g -fbacktrace -fcheck=all -ffpe-trap=invalid,zero,overflow -finit-real=snan
...
#
seq omp seq_debug omp_debug debug ifort ifort_seq ifort_omp : export PARALLEL_SKY = sequential.o
...
#
seq omp mpi debug seq_debug mpi_debug omp_debug mpi-omp ifort ifort_seq ifort_omp:
...
external.o : external.f90 params.o $(PARALLEL_SKY) grids.o levels.o meanfield.o Makefile
...
moment.o : moment.f90 params.o grids.o densities.o Makefile
